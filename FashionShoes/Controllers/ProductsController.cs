...
namespace FashionShoes.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ActionResult Shoes(int id = -1, int page = 1)
        {
            int totalRecord = 0;
            ViewBag.listProduct = getManyShoes(ref totalRecord, id, page);
        ...
        public List<tb_SanPham> getManyShoes(ref int totalRecord, int idThgHieu, int page = 1, int pageSize = 12)
        {
